...
{{--                        <li><a href="#contact">contact</a></li>--}}
        ...
        <!--==  7. Menu List With Afordable Pricing  ==-->
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Menu List With Affordable Pricing</h2>
                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach($items as $item)
                                    <li class="item" id="{{ $item->category->slug }}">
                                        ...
                                        <a href="#">
                                            <img src="{{ asset('uploads/item/'.$item->image) }}" class="img-responsive" alt="Food" style="height: 200px; width: 250px;" >
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2021 <a href="#">DIU Smart Canteen.</a> Developed By<a href="https://github.com/Asif1881"> Asif Ikbal.</a> Theme By<a href="http://themewagon.com/"  target="_blank"> ThemeWagon</a>
                            </p>
                        </div>
                    </div>
                </div>
